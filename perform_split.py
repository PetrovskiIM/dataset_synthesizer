...
from config import copying_files_names as template_names, midi_files_copies_storage_path as template_storage_path, \
    chunks, \
...
if __name__ == '__main__':
    ...
    dispatcher = []
    names = dispatcher_df["name"].values
    ...
    for chunk_i, chunk in enumerate(chunks):
        ...
        dispatcher_df["path"] = [f"{target_path}/{name}_{chunk['begin_i']}_{chunk['end_i']}.mid" for name in names]
